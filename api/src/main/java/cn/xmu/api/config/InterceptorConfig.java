package cn.xmu.api.config;


import cn.xmu.api.interceptors.AdminTokenInterceptor;
import cn.xmu.api.interceptors.ArticleReadInterceptor;
import cn.xmu.api.interceptors.PassportInterceptor;
...
//
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(passportInterceptor())
                .addPathPatterns("/passport/getCode");
