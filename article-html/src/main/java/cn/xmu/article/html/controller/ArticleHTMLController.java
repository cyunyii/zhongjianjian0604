...
import cn.xmu.api.article.ArticleHTMLControllerApi;
...
public class ArticleHTMLController implements ArticleHTMLControllerApi {
    ...
    final static Logger logger = LoggerFactory.getLogger(cn.xmu.article.html.controller.ArticleHTMLController.class);
